...
class CrearNuevoAdminFragment : Fragment() {
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_crear_nuevo_admin, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnnRegistrarse.setOnClickListener {
            ...
            {
                var url = "http://royalbrave.es/api/v1/user/createAdmin"
                ...
                val jsonObjectRequest = object : JsonObjectRequest(
                    ...
                    Response.Listener { response ->
                        findNavController().navigate(R.id.action_crearNuevoAdminFragment_to_panelAdminFragment2)
                    },
                ...
                if (contrasenaEditText.text.isNotEmpty() && validacionContrasena.matches(contrasenaEditText.text.toString())) {
                    // La contraseña cumple con las reglas de complejidad
                } else {

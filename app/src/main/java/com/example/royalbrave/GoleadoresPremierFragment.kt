...
class GoleadoresPremierFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_goleadores_premier, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        GlobalScope.launch {
            ...
            val url = "http://royalbrave.es/api/v1/futbol/getTopScoresPremier"
                ...
                { response ->
                    ...
                    if (jsonArray.length() != 0) {
                        val arrayJugadores = response.getJSONObject(0)
                            .getJSONObject("top_scores_premier")
                        ...
                        for (i in 0 until arrayJugadores.length()) {
                            ...
                            Log.i("JUGADORes--->", player.toString())
                    }
                    }else{
                        showAlert("No se han podido cargar los goleadores de la Premier League")
                    }
                    MainScope().launch {
                        val rvList = view.findViewById<RecyclerView>(R.id.recyclerViewGoleadoresPremier)
